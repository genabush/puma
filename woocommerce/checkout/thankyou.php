...
<div class="container--two-columns">
	...
	<?php if ( $order ) : ?>
		...
		<?php else : ?>
			...
			<div class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received">
                ...
                <?php echo get_field('description_th', 'option') ? get_field('description_th', 'option') : '' ; ?>
            </div>
	...
	<?php else : ?>
		...
		<div class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received">
            <h4><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', __( 'Thank you. Your order has been received.', 'woocommerce' ), $order ); ?></h4>        </div>
